...
uses
  ...
  DelphiPDV.View.Other44 in 'src\View\DelphiPDV.View.Other44.pas' {Form3};
...
begin
  ...
  Application.CreateForm(TVwOther42, VwOther42);
  Application.CreateForm(TVwOther43, VwOther43);
