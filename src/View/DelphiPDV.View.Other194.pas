...
procedure TForm192.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case Key of
...
procedure TForm192.Process;
begin
  Review;
  Close;
end;

procedure TForm192.Review;
begin
