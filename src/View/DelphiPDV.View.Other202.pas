...
procedure TForm201.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case Key of
...
procedure TForm201.Process;
begin
  Review;
  Close;
end;

procedure TForm201.Review;
begin
