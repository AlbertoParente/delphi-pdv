...
procedure TForm214.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case Key of
...
procedure TForm214.Process;
begin
  Review;
  Close;
end;

procedure TForm214.Review;
begin
