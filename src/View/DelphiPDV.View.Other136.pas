...
procedure TForm126.cxGridDBTableView1CustomDrawCell(
...
procedure TForm126.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case Key of
...
procedure TForm126.Process;
begin
  Review;
  Close;
end;

procedure TForm126.Review;
begin
