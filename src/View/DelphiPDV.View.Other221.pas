...
procedure TForm220.cxGridDBTableView1CustomDrawCell(
...
procedure TForm220.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case Key of
...
procedure TForm220.Process;
begin
  Review;
  Close;
end;

procedure TForm220.Review;
begin
