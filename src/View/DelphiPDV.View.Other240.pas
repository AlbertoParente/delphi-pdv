...
procedure TForm239.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case Key of
...
procedure TForm239.Process;
begin
  Review;
  Close;
end;

procedure TForm239.Review;
begin
