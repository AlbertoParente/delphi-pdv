...
procedure TForm153.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case Key of
...
procedure TForm153.Process;
begin
  Review;
  Close;
end;

procedure TForm153.Review;
begin
