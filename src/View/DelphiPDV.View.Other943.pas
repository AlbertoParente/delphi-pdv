...
procedure TForm92.cxGridDBTableView1CustomDrawCell(
...
procedure TForm92.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case Key of
...
procedure TForm92.Process;
begin
  Review;
  Close;
end;

procedure TForm92.Review;
begin
