...
procedure TForm173.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case Key of
...
procedure TForm173.Process;
begin
  Review;
  Close;
end;

procedure TForm173.Review;
begin
