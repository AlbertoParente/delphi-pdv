...
procedure TForm244.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case Key of
...
procedure TForm244.Process;
begin
  Review;
  Close;
end;

procedure TForm244.Review;
begin
