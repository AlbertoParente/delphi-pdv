...
procedure TVwOther4.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TVwOther4.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case Key of
...
procedure TVwOther4.FormShow(Sender: TObject);
begin
  aDataSource.DataSet := nil;
end;

procedure TVwOther4.GridViewCustomDrawCell(Sender: TcxCustomGridTableView;
  ACanvas: TcxCanvas; AViewInfo: TcxGridTableDataCellViewInfo;
  var ADone: Boolean);
begin
  inherited;
...
procedure TVwOther4.Process;
begin
  Review;
  Close;
end;

procedure TVwOther4.Review;
begin
