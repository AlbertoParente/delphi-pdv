...
procedure TForm230.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case Key of
...
procedure TForm230.Process;
begin
  Review;
  Close;
end;

procedure TForm230.Review;
begin
