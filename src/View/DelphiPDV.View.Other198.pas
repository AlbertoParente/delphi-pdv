...
procedure TForm197.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case Key of
...
procedure TForm197.GridViewCustomDrawCell(Sender: TcxCustomGridTableView;
  ACanvas: TcxCanvas; AViewInfo: TcxGridTableDataCellViewInfo;
  var ADone: Boolean);
begin
  inherited;
...
procedure TForm197.Process;
begin
  Review;
  Close;
end;

procedure TForm197.Review;
begin
