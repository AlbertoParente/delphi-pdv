...
procedure TForm189.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TForm189.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TForm189.FormShow(Sender: TObject);
begin
  EditPesquisa.Clear;
  aDataSource.DataSet := nil;
end;

procedure TForm189.Process;
begin
  Review;
  Close;
end;

procedure TForm189.Review;
begin
