...
procedure TForm155.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  case Key of
...
procedure TForm155.Process;
begin
  Review;
  Close;
end;

procedure TForm155.Review;
begin
